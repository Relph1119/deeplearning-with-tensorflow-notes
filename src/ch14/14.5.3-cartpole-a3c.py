...
"""
@author: HuRuiFeng
@file: 14.5.3-cartpole-a3c.py
@time: 2020/2/29 23:50
@desc: 14.5.3 A3C实战的代码
"""
...
class Agent:
    ...
    def train(self):
        ...
        plt.xlabel('回合数')
        plt.ylabel('总奖励得分')
        plt.savefig('14.5.3-cartpole-a3c.svg')
        ...
        for epi_counter in range(500):  # 未达到最大回合数
            ...
            while not done:
                ...
                if ep_steps >= 500 or done:
                    ...
                    print("epoch=%s," % epi_counter, "worker=%s," % self.worker_idx, "reward=%s" % ep_reward)
                    break
